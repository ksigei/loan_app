...
class Loan(models.Model):
    loan_application = models.OneToOneField(LoanApplication, on_delete=models.CASCADE, primary_key=True)
    amount = models.DecimalField(max_digits=10, decimal_places=2)
...
class Transaction(models.Model):
    ...
    def __str__(self):
        return f"Transaction of {self.amount} for {self.loan.loan_application.business.name}"
